...
def test_two_node_shapes_sharing_a_label_fails(make_graph):
    g = make_graph("""
    :CatShape a sh:NodeShape ; sh:name "Animal Shape" .
    :DogShape a sh:NodeShape ; sh:name "Animal Shape" .
    """)
...
def test_two_property_shapes_sharing_a_label_fails(make_graph):
    g = make_graph("""
    :hasFurShape a sh:PropertyShape ; sh:name "Has Feature" .
    :hasTailShape a sh:PropertyShape ; sh:name "Has Feature" .
    """)
